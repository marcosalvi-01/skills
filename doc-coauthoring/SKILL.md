...
**If integrations are available** (e.g., Slack, Notion, Google Drive, SharePoint, or other MCP servers), mention that these can be used to pull in context directly.
